...
; On return: #5063 holds the probed Z and the tool sits at the
; slow-probe contact point (G91 active).  The caller records the
; result, sets any datum, and backs off.
